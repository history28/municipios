...
<div class="cuerpoc">
  <table width="95%" border="0" cellpadding="0" cellspacing="2">
    ...
    <tr>
      <td><span class="Estilo6">Municipalidad   de <? echo $varnombre; ?></span></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
        ...
        <tr>
          <td>&nbsp;
              <table width="400" border="0" cellpadding="0" cellspacing="2">
                <tr>
                  <td><strong>QUEJA:</strong> <span class="letra1"><?php echo $result2; ?></span></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
...
$result = mysql_query("SELECT camp0, idor, loginor, iddes, logindes, fecha, puntos FROM puntos WHERE iddes = '$id' order by camp0 DESC limit 0,15", $dbh);
	...
	?>
          ...
          <td valign="top"><table width="400" border="0" cellpadding="4" cellspacing="0">
              <tr>
                <td><strong>RESPUESTA A ESTA QUEJA</strong> </td>
              </tr>
              <tr>
                <td>
<?
...
?>
				  <p class="letra1">
				    <?php echo $varresp; ?></p>
					  <a href="<?php echo $varlink; ?>" target="_blank">ver link de verificacion</a>					
<?
}
?>
