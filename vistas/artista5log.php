...
<?
$result = mysql_query("SELECT camp0, idcant, nombre, descripcion, estilo, decada, precio, foto FROM tienda WHERE idautor = '$idus' order by camp0 DESC limit 0,15", $dbh);
	while($row = mysql_fetch_array($result))
	{
		...
		?>
          <tr>
            ...
            <td>&nbsp;
				<a href="producto1log.php?id=<?php	echo $row["camp0"]; ?>"><span class="Estilofont1">
              <?php	echo $row["nombre"]; ?>
            </span></a>			</td>
            ...
            <td>
			<a href="producto1log.php?id=<?php	echo $row["camp0"]; ?>"><img src="img/boton3.png" width="130" height="25" border="0" />			</a></td>
          </tr>
		<tr>
		  <td colspan="4"><hr /></td>
		  </tr>
