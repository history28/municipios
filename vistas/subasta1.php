...
<div class="cuerpoc">
  <p>
  <div id="subcontent"></p>
      <span class="Estilo1"> COMPRAR PRODUCTO</span>
      <form id="form1" name="form1" method="post" action="subastagraba.php">
      <table width="400" border="0" cellpadding="4" cellspacing="0">
        ...
        <tr>
          <td colspan="2"><span class="Estilo1">Confirmar compra</span></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>id prod  : </td>
        ...
        <tr>
          <td>precio base: </td>
          <td><? echo $varmoneda; ?> <? echo $varprecio1; ?></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>ultima oferta: </td>
          <td>&nbsp;<? echo $varprecio2; ?></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>ofrecer : </td>
          <td><input name="precio2" type="text" value="<? echo $varprecio2; ?>" /></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>comentario</td>
        ...
        <tr>
          <td>&nbsp;</td>
          <td><label>
            <input type="submit" name="Submit" value="Confirmar la compra" />
          </label></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
