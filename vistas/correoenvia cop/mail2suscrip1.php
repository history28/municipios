...
if ($_POST['action'] == "send") {
	...
	$mail->From = "netlima2014@gmail.com";
	...
	//}
	$body = "¡Enhorabuena! Se ha confirmado su registro a nuestra Web <a href='http://www.netlima.com/red1'>www.netlima.com</a><br>".$_POST['mensaje'];
	$body.= "<BR>";
	...
	$body.= "<BR>Nick: ".$_POST['DA1'];
	$body.= "<BR>Password: ".$_POST['pass2'];
...
<body>
	...
	//include("connec.php");
$dbh=mysql_connect ("localhost", "netlima_elmer1", "alberto2jorge21") or die ('I cannot connect to the database because: ' . mysql_error());
			mysql_select_db ("netlima_data1"); 

	$sql = "INSERT INTO suscripciones(camp0, id1, id2, login1, login2, email1, email2, fecha, hora, descripcion, area)";
	$sql .= "VALUES ('', '0', '0', '$nom1', '', '$correo1', '$camp1', '$fecha1', '$hora2', '$mensaje1', '$tipo')";
