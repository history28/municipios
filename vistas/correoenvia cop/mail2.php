...
if ($_POST['action'] == "send") {
	...
	$body.= "<br><a href='http://www.netlima.com'><img src='http://www.netlima.com/ang/Logo3.png' width='264' height='100' /></a>";
	$body.= "<table width='80%'  border='1' cellpadding='4' cellspacing='0' bgcolor='#CCCCCC'><tr><td align='center'><font size='4' color='#0000FF'>aaaa</font></td><td>bbbb</td></tr><tr><td>&nbsp;</td><td >&nbsp;</td></tr></table>";
