...
$result = mysql_query("SELECT camp0, idprod, idautorori, nomautorori, fecha FROM adhesiones WHERE idprod = '$idprod' AND idautorori = '$idus' order by camp0 DESC limit 0,15", $dbh);
...
{
?>
      <span class="Estilo1">NO PUEDES REPETIR TU ADHESION EN UN MISMO TEMA </span><BR />
