				...
				<tr>
				  ...
				  <table width="700" border="0" cellpadding="4" cellspacing="1">
                    ...
                    <tr>
                      ...
                      <td align="left">
                        <input name="id1" type="text" value="<?php echo $varnombre; ?>" />
                      </td>
                      <td>&nbsp;</td>
                    ...
                    <tr>
                      ...
                      <td align="left">
					  <input type="text" name="tipo" value="<?php echo $varapellido; ?>" />
					  </td>
                      <td>&nbsp;</td>
                    ...
                    <tr>
                      ...
                      <td align="left">
					  <input type="text" name="status" value="<?php echo $varemail; ?>" />
					  </td>
                      <td>&nbsp;</td>
