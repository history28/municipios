...
<div class="cuerpoc">
  <p>
    ...
    <table width="400" border="0" cellpadding="4" cellspacing="0">
      <tr>
        <td align="center">&nbsp;<a href="#"><span class="menusub">BUSCAR INGRESOS</span></a></td>
          <td align="center">&nbsp;<a href="#"><span class="menusub">PAGOS ANTICIPADOS</span></a></td>
          <td align="center">&nbsp;<a href="#"><span class="menusub">REPORTE FACTURAS</span></a></td>
        </tr>
      <tr>
        <td align="center">&nbsp;</td>
        <td align="center">&nbsp;</td>
...
$result = mysql_query("SELECT camp0, idusu, concepto, cantidad, categoria, fecha, formapago FROM pagos order by camp0 DESC limit 0,15", $dbh);
