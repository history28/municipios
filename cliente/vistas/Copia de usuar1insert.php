...
$sql = "INSERT INTO amigos2a(camp0, seudonimo, password, email, edad, sexo, educ, activ, sector, vive_en, descripcion, fecha_ing)";
$sql .= "VALUES ('', '$texto2', '$texto3', '$texto4', '$texto6', '$pComput0', '$pComput1', '$pComput2', '$pComput3', '$pComput4', '$texto5', '$fecha1')";
