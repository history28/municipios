...
<div class="cuerpoc">
  ...
  <table width="800" border="0" cellpadding="0" cellspacing="2">
    ...
    <tr>
      <td><strong>LISTA DE SUGERENCIAS</strong></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td><hr /></td>
    ...
    <tr>
      <td><table width="800" border="1" cellpadding="3" cellspacing="0" bgcolor="#EBEBEB">
		<tr>
		  ...
		  <td bgcolor="#333333"><span class="cabeztabla">MENSAJE</span></td>
		  <td bgcolor="#333333"><span class="cabeztabla">Eliminar</span></td>
		</tr>
<?
$result = mysql_query("SELECT camp0, titulo, descripcion, fecha, autor FROM contacto  order by camp0 DESC limit 0,80", $dbh);
	...
	?>
          <tr>
            ...
            <td><a href="borrasuge.php?id=<?php echo $row["camp0"]; ?>&pase=0&tables=cantantes">borrar</a></td>
          </tr>
    <?php
	}
	?>
