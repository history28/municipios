...
<div class="cuerpoc">
  ...
  <table width="800" border="0" cellpadding="0" cellspacing="2">
    ...
    <tr>
      <td><a href="admopina.php">ver las opiniones </a></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      <td><strong>LISTA DE ADHESIONES </strong></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td><hr /></td>
...
<?
$result = mysql_query("SELECT camp0, idprod, idautorori, nomautorori, idautordes, nomautordes, preg, estado, fecha, tipo FROM adhesiones order by camp0 DESC limit 0,80", $dbh);
