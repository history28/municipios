...
<div class="cuerpoc">
  ...
  <table width="800" border="0" cellpadding="0" cellspacing="2" bgcolor="#000000">
    ...
    <tr>
      <td><span class="Estilo6">Relacion de quejas</span></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
	  ...
	  <table width="800" border="0">
	    <tr>
<?
$result = mysql_query("SELECT camp0, idcant, nombre, descripcion, estilo, decada, precio, foto, precio1, fecha, apoyos, autor, idautor FROM tienda WHERE idautor = '$idus' order by apoyos DESC, camp0 DESC limit 0,15", $dbh);
$filas = mysql_num_rows($result);
if ($filas=="")
{
?>
	  <tr>
		<td colspan="6">Todavia no hay publicaciones en la Tienda, aqui puedes comprar o vender, se el primero en publicar.		</td>
	  </tr>
<?
}
Else
...
$resultcan3 = mysql_result($resultcan, 0, 0 );   //0 es el row, 1 es el campo   
		...
		?>
          <tr>
            ...
            <td>&nbsp;
				<a href="producto1a.php?id=<?php	echo $row["camp0"]; ?>"><span class="Estilofont1">
              <?php	echo $row["nombre"]; ?>
            </span></a>			</td>
            <td><span class="Estilo7"><?php	echo $row["fecha"]; ?>
            </span></td>
            <td>&nbsp;<?php	echo $row["apoyos"]; ?> adhesiones</td>
            <td>
			<a href="producto1a.php?id=<?php	echo $row["camp0"]; ?>"><img src="img/boton3.png" width="130" height="25" border="0" />			</a></td>
            <td><?php echo $resultcan2; ?> - 
			<a href="artista1.php?id=<?php echo $resultcan3; ?>">
