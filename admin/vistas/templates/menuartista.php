...
<?
	  $result = mysql_query("SELECT camp0, id1, nombre, descripcion, biografia, discografia, recomendacion, foto, estilo FROM cantantes WHERE camp0 = '$id' order by camp0 DESC limit 0,15", $dbh);
